<div class="row mt-4 main-web">
    ...
    <form action="?act=ctbill" method="post">
        ...
        <div class="col-md-12" style="display: grid; grid-template-columns: 1fr 1fr; width: 80%; margin-left: 10%; font-size: 15px;">
            <div class="card mt-5">
            ...
            <div class="card_ctbill mt-5">
                ...
                <!-- </div> -->
                <table class="table_ctbill" style=" margin: 25px 100px; width: 69%;">
